              ...
              <tr>
                ...
                <tr>
                  <td width="100%" height="24">
                    &nbsp; <span style="letter-spacing: 2"><b><font color="#000000">Up video</font></b> &gt; List</span>
                  </td>
                </tr>
              </table>
                ...
                <td width="100%">
                  <table border="0" cellpadding="0" cellspacing="5" width="100%">
                    <tr>
                      ...
                      <td width="50%" align="center" height="25" bgcolor="#616D7E" style="color:#FFFFFF"><b>Tên video</b></td>
				      <td width="10%" align="center" height="25" bgcolor="#616D7E" style="color:#FFFFFF"><b>Ngày gửi</b></td>	
                      <td width="10%" align="center" height="25" bgcolor="#616D7E" style="color:#FFFFFF"><b>Xóa</b></td>
                    </tr>
...
$sql = "SELECT a.id, a.name, a.createdate FROM video a ORDER BY a.id DESC LIMIT $offset, $rowsPerPage";
...
while ($row=mysql_fetch_array($result))
{
	...
	echo "<td align = 'center'>&nbsp;&nbsp;&nbsp;<a href='delete.php?id=$p_id'><img src='../images/b_drop.png' border='0' alt='Delete' onclick=\"javascript:return confirm('Bạn có chắc chắn muốn xóa bản ghi $p_id ?');\"></a></td></tr>";	
}
...
$sql   = "SELECT COUNT(id) AS numrows FROM video";
$result = mysql_query($sql, $link);
