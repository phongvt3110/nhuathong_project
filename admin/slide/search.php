              ...
              <tr>
                ...
                <tr>
                  <td width="100%" height="24">
                    &nbsp; <span style="letter-spacing: 2"><b><font color="#000000">Slide ảnh</font></b> &gt; Tìm kiếm</span>
                  </td>
                </tr>
              </table>
...
if ($q != "") 	
	...
	$sql = "SELECT a.id, a.title, a.createdate FROM slide a  " . $sWhere . " ORDER BY a.id DESC LIMIT $offset, $rowsPerPage";
//echo $sql;exit;
...
$sql   = "SELECT COUNT(id) AS numrows FROM slide a " . $sWhere . "";
$result = mysqli_query($link, $sql);
