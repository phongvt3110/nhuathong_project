              ...
              <tr>
                ...
                <tr>
                  <td width="100%" height="24">
                    &nbsp; <span style="letter-spacing: 2"><b><font color="#000000">Silde ảnh</font></b> &gt; List</span>
                  </td>
                </tr>
              </table>
                ...
                <td width="100%">
                  <table border="0" cellpadding="0" cellspacing="5" width="100%">
                    <tr>
					  ...
					  <td width="20%" align="center" height="25" bgcolor="#616D7E" style="color:#FFFFFF"><b>Vị trí</b></td>
...
$sql = "SELECT a.id, a.title, a.createdate,a.type FROM slide a ORDER BY a.id DESC LIMIT $offset, $rowsPerPage";
...
while ($row=mysqli_fetch_array($result))
{
	...
	echo "<td>$p_name</td>";
	if($p_type == 1){
	 echo "<td align=\"center\">quảng cáo trên banner</td>";
	}else if($p_type == 2){
	 echo "<td align=\"center\">công nhân xây dựng</td>";
	}
...
$sql   = "SELECT COUNT(id) AS numrows FROM slide";
$result = mysqli_query($link, $sql);
