              ...
              <tr>
                ...
                <tr>
                  <td width="100%" height="24">
                    &nbsp; <span style="letter-spacing: 2"><b><font color="#000000">Dịch vụ</font></b> &gt; List</span>
                  </td>
                </tr>
              </table>
...
$sql = "SELECT s.id, s.title, s.postdate FROM services s  ORDER BY s.id DESC LIMIT $offset, $rowsPerPage";
