...
?>
                  ...
                  <table border="0" cellpadding="0" cellspacing="5" width="100%">
                    <tr>
                      ...
                      <td width="20%" align="center" height="25" bgcolor="#616D7E" style="color:#FFFFFF"><b>Ngày gửi</b></td>	
...
$q = cleanQuery($_GET["q"]);
if ($q != "") 	
	$sWhere = "WHERE s.title like '%" . $q . "%'";
else
	$sWhere = "";
		
	$sql = "SELECT s.id, s.title,s.postdate FROM services s  " . $sWhere . " ORDER BY s.id DESC LIMIT $offset, $rowsPerPage";
//echo $sql;exit;
...
$sql   = "SELECT COUNT(id) AS numrows FROM services s " . $sWhere . "";
$result = mysql_query($sql, $link);
