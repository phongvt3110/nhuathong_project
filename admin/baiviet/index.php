              ...
              <tr>
                ...
                <tr>
                  <td width="100%" height="24">
                    &nbsp; <span style="letter-spacing: 2"><b><font color="#000000">Thuê viết bài</font></b> &gt; List</span>
                  </td>
                </tr>
              </table>
...
$sql = "SELECT a.id, a.title, b.name, a.postdate,a.actives FROM product a INNER JOIN category b ON a.cateid=b.id and a.actives =0 ORDER BY a.id DESC LIMIT $offset, $rowsPerPage";
...
$sql   = "SELECT COUNT(id) AS numrows FROM product where and actives =0";
$result = mysql_query($sql, $link);
