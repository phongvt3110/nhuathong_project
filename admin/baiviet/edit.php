		...
		if(f.title.value==''){
		   ...
		   alert('Bạn chưa nhập gía?');
			...
			alert('Bạn chưa chọn trạng thái sản phẩm');
		 	f.hot.focus();
			return false;
		}else if(f.actives.value=='0') {
			alert('Bạn chưa duyệt bài viết');
		 	f.actives.focus();
			return false;
		}
              ...
              <tr>
                ...
                <tr>
                  <td width="100%" height="24">
                    &nbsp; <span style="letter-spacing: 2"><b><font color="#000000">Thuê viết bài</font></b> &gt; Chỉnh sửa</span>
                  </td>
                </tr>
              </table>
...
?>                
	...
	['Maximize', 'ShowBlocks','-','About']
					...
					<tr>
                      <td>Duyệt bài:<font color="red">*</font></td>
                      <td>
					  <select name="actives" id="actives">
					  		<?php
							 $a =array("Chưa duyệt"=>0,"Đã duyệt"=>1);
							 foreach($a as $k=>$v){
							 if ($p_actives==$v)
								echo "<option value=".$v." selected>".$k."</option>";
								else
